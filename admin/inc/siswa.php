...
if(@$_SESSION['admin']) { ?>
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">Manajemenen Data Mahasiswa</h1>
        </div>
    </div>
<?php
}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning">
                    Admin tidak dapat mengedit data mahasiswa. Admin hanya dapat mengaktifkan dan menonaktifkan serta menghapus akun mahasiswa. Untuk mengedit data siswa yang berhak ialah siswa itu sendiri.
                </div>
            </div>
        </div>
    <?php
