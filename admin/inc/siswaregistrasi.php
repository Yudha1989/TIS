...
if(@$_SESSION['admin']) {
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">Manajemenen Registrasi Mahasiswa</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Data Mahasiswa yang Registrasi (Mendaftar) &nbsp; <a href="./laporan/cetak.php?data=siswaregistrasi" target="_blank" class="btn btn-default btn-xs">Cetak Data Siswa</a></div>
