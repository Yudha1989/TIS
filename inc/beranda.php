    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-success">
                ...
                Selamat datang di e-learning Center Indonesia.<br />
                Silahkan pilih menu sesuai kebutuhan Anda, jika ada yang kurang jelas silahkan bertanya kepada administrator.
            </div>
        </div>
    </div>
<?php
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form method="post" enctype="multipart/form-data">
                NIM* :<input type="text" name="nis" value="<?php echo $data['nis']; ?>" class="form-control" required />
