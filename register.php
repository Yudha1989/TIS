<?php
@session_start();
$db = mysqli_connect("localhost", "root", "xxx", "db_elearning");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Daftar E-Learning Indonesia</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            NIM* :<input type="text" name="nis" class="form-control" required />
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    &copy; 2025 E-Learning Center Indonesia | By : yudha.gustian@pln.co.id
                </div>
